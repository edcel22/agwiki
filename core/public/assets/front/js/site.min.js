...
MarkerLabel.prototype.onRemove = function () {
        ...
        function n() {
            if (!h) {
                ...
                if (d = function () {
                        ...
                        return function (t) {
                            var i = e(t);
                            return i || a("Style returned " + i + ". Are you running this code in a hidden iframe on Firefox? See https://bit.ly/getsizebug1"), i
                        }
                    }(), c = t("boxSizing")) {
        ...
        function s(e) {
            if (n(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                var v = s.paddingLeft + s.paddingRight, y = s.paddingTop + s.paddingBottom,
                    b = s.marginLeft + s.marginRight, w = s.marginTop + s.marginBottom,
                    x = s.borderLeftWidth + s.borderRightWidth, S = s.borderTopWidth + s.borderBottomWidth, C = a && u,
                    T = i(t.width);
    ...
    o.extend(a.prototype, t.prototype), a.prototype._create = function () {
        ...
        var e = d(this.element), t = this.layout.options, i = t.isOriginLeft, n = t.isOriginTop,
            o = e[i ? "left" : "right"], s = e[n ? "top" : "bottom"], a = this.layout.size,
        ...
        var e = this.layout.size, t = this.layout.options, i = {}, n = t.isOriginLeft ? "paddingLeft" : "paddingRight",
            o = t.isOriginLeft ? "left" : "right", s = t.isOriginLeft ? "right" : "left", a = this.position.x + e[n];
        i[o] = this.getXValue(a), i[s] = "";
        var r = t.isOriginTop ? "paddingTop" : "paddingBottom", l = t.isOriginTop ? "top" : "bottom",
            d = t.isOriginTop ? "bottom" : "top", c = this.position.y + e[r];
    ...
    return n.prototype._resetLayout = function () {
        ...
        var i = t(e), n = this._getElementOffset(e), o = this.options.isOriginLeft ? n.left : n.right,
    ...
    var n = e.create("masonry"), o = n.prototype._getElementOffset, s = n.prototype.layout,
    ...
    var p = function () {
        function e(e) {
            ...
            var i = d(e).split(" "), n = i[0], o = n.match(/^\[(.+)\]$/), s = o && o[1], a = t(s, n),
    ...
    e.fn.bxSlider = function (o) {
        ...
        var r = e(window).width(), l = e(window).height(), d = function () {
            ...
            var n = "horizontal" == s.settings.mode ? -t.left : -t.top,
                o = "horizontal" == s.settings.mode ? -i.left : -i.top, r = {resetValue: o};
            w(n, "ticker", speed, r)
        }, W = function () {
            ...
            var t = e.originalEvent, i = Math.abs(t.changedTouches[0].pageX - s.touch.start.x),
    ...
    !function (t) {
        ...
        var t, i = "mCustomScrollbar", n = "mCS", o = ".mCustomScrollbar", s = {
            ...
            }, a = 0, r = {}, l = window.attachEvent && !window.addEventListener ? 1 : 0, d = !1,
            ...
            u = {
                init: function (t) {
                    ...
                    return e(o).each(function () {
                        var t = e(this);
                        if (t.data(n)) {
                            var o = t.data(n), s = o.opt, a = e("#mCSB_" + o.idx + "_container"),
                                r = e("#mCSB_" + o.idx),
                        ...
                        return e(o).each(function () {
                            ...
                            if (o.data(n)) {
                                var s = o.data(n), a = s.opt, r = {
                                        ...
                                        onUpdate: !0,
                                        onComplete: !0
                                    }, l = e.extend(!0, {}, r, i), d = N.call(this, t),
                    ...
                    return e(t).each(function () {
                        var o = e(this);
                        if (o.data(n)) {
                            var s = o.data(n), a = s.opt, r = e("#mCSB_" + s.idx),
                                l = e("#mCSB_" + s.idx + "_container"), d = e(".mCSB_" + s.idx + "_scrollbar");
                ...
                var t = e(this), o = t.data(n), s = o.opt, a = s.autoExpandScrollbar ? " " + c[1] + "_expand" : "",
                    ...
                    h = s.autoHideScrollbar ? " " + c[6] : "", p = "x" !== s.axis && "rtl" === o.langDir ? " " + c[7] : "";
                ...
                var t = e(this), i = t.data(n), o = i.opt, s = e(".mCSB_" + i.idx + "_scrollbar:first"),
                ...
                var t = e(this), i = t.data(n), o = e("#mCSB_" + i.idx), s = e("#mCSB_" + i.idx + "_container"),
                    ...
                    c = l && d[1] < d[0] ? d[0] : d[1], u = l && d[3] < d[2] ? d[2] : d[3];
                a[0].css({
                    height: c,
                ...
                var t = e(this), i = t.data(n), o = e("#mCSB_" + i.idx), s = e("#mCSB_" + i.idx + "_container"),
                    ...
                    r = null == i.overflowed ? s.width() : s.outerWidth(!1), l = s[0].scrollHeight, d = s[0].scrollWidth;
                ...
                function i(e, t, i, n) {
                    if (m[0].idleTimer = u.scrollInertia < 233 ? 250 : 0, o.attr("id") === p[1]) var s = "x",
                        a = (o[0].offsetLeft - t + n) * c.scrollRatio.x; else var s = "y",
                        a = (o[0].offsetTop - e + i) * c.scrollRatio.y;
                    Y(r, a.toString(), {dir: s, drag: !0})
                }

                var o, s, a, r = e(this), c = r.data(n), u = c.opt, h = n + "_" + c.idx,
                    p = ["mCSB_" + c.idx + "_dragger_vertical", "mCSB_" + c.idx + "_dragger_horizontal"],
                    m = e("#mCSB_" + c.idx + "_container"), f = e("#" + p[0] + ",#" + p[1]),
                ...
                f.bind("mousedown." + h + " touchstart." + h + " pointerdown." + h + " MSPointerDown." + h, function (i) {
                    if (i.stopImmediatePropagation(), i.preventDefault(), K(i)) {
                        ...
                        var n = o.offset(), c = I(i)[0] - n.top, h = I(i)[1] - n.left, p = o.height() + n.top,
                            m = o.width() + n.left;
                ...
                var c, u, h, p, m, f, g, v, y, b, w, x, S, C, T = e(this), k = T.data(n), j = k.opt, _ = n + "_" + k.idx,
                    E = e("#mCSB_" + k.idx), M = e("#mCSB_" + k.idx + "_container"),
                    P = [e("#mCSB_" + k.idx + "_dragger_vertical"), e("#mCSB_" + k.idx + "_dragger_horizontal")], F = [],
                    L = [], D = 0, z = "yx" === j.axis ? "none" : "all", B = [], W = M.find("iframe"),
                ...
                var s, a = e(this), r = a.data(n), l = r.opt, c = r.sequential, u = n + "_" + r.idx,
                    h = e("#mCSB_" + r.idx + "_container"), p = h.parent();
                ...
                function t(t, n) {
                    if (q(i), !D(i, t.target)) {
                        ...
                        if ("x" === s.axis || "x" === s.mouseWheel.axis) var c = "x",
                            ...
                            p = Math.abs(e("#mCSB_" + o.idx + "_container")[0].offsetLeft), m = d[1][0].offsetLeft,
                            f = d[1].parent().width() - d[1].width(), g = t.deltaX || t.deltaY || n; else var c = "y",
                            ...
                            p = Math.abs(e("#mCSB_" + o.idx + "_container")[0].offsetTop), m = d[0][0].offsetTop,
                            f = d[0].parent().height() - d[0].height(), g = t.deltaY || n;
                ...
                if (e(this).data(n)) {
                    var i = e(this), o = i.data(n), s = o.opt, a = n + "_" + o.idx, r = e("#mCSB_" + o.idx),
                ...
                var t = e(this), i = t.data(n), o = n + "_" + i.idx, s = e("#mCSB_" + i.idx + "_container"), a = s.parent(),
                ...
                r.bind("touchstart." + o + " pointerdown." + o + " MSPointerDown." + o, function (e) {
                    ...
                    if (e(n.target).hasClass(c[12]) || e(n.target).hasClass("mCSB_draggerRail")) {
                        ...
                        if (o.parent(".mCSB_scrollTools_horizontal").length > 0) {
                            ...
                            var l = "x", d = n.pageX > r.offset().left ? -1 : 1,
                                u = Math.abs(s[0].offsetLeft) - .9 * d * a.width()
                        } else {
                            if (!i.overflowed[0]) return;
                            var l = "y", d = n.pageY > r.offset().top ? -1 : 1,
                ...
                a.bind("focusin." + s, function (i) {
                    ...
                    n.is(o.advanced.autoScrollOnFocus) && (q(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = s ? (l + 17) * s : 0, t[0]._focusTimeout = setTimeout(function () {
                        var e = [te(n)[0], te(n)[1]], i = [a[0].offsetTop, a[0].offsetLeft],
                ...
                var t = e(this), i = t.data(n), o = i.opt, s = i.sequential, a = n + "_" + i.idx,
                    r = ".mCSB_" + i.idx + "_scrollbar", l = e(r + ">a");
                            ...
                            if ("x" !== s.axis && (38 === r || 40 === r) || "y" !== s.axis && (37 === r || 39 === r)) {
                                ...
                                if ((o.overflowed[0] || o.overflowed[1]) && (t.preventDefault(), t.stopImmediatePropagation()), "keyup" === t.type) {
                                    ...
                                    if ("x" === s.axis || "yx" === s.axis && o.overflowed[1] && !o.overflowed[0]) var p = "x",
                                        m = Math.abs(d[0].offsetLeft) - .9 * h * c.width(); else var p = "y",
                                ...
                                if ("x" === s.axis || "yx" === s.axis && o.overflowed[1] && !o.overflowed[0]) var p = "x",
                                    m = 35 === r ? Math.abs(c.width() - d.outerWidth(!1)) : 0; else var p = "y",
                ...
                var i = e(this), o = i.data(n), s = o.opt, a = o.sequential, r = n + "_" + o.idx, l = e("#mCSB_" + o.idx),
                    d = e("#mCSB_" + o.idx + "_container"), c = d.parent(),
                    u = "input,textarea,select,datalist,keygen,[contenteditable='true']", h = d.find("iframe"),
                ...
                function r(e) {
                    var i = "stepped" !== h.type, n = a ? a : e ? i ? f / 1.5 : g : 1e3 / 60, o = e ? i ? 7.5 : 40 : 2.5,
                        ...
                        y = s ? s : e ? i ? "mcsLinearOut" : "mcsEaseInOut" : "mcsLinear", b = e ? !0 : !1;
                ...
                var d = t.data(n), u = d.opt, h = d.sequential, p = e("#mCSB_" + d.idx + "_container"),
                    m = "stepped" === h.type ? !0 : !1, f = u.scrollInertia < 26 ? 26 : u.scrollInertia,
                ...
                if (null != t && "undefined" != typeof t) {
                    ...
                    var c = "x" === i ? r.outerWidth(!1) : r.outerHeight(!1),
                        h = "x" === i ? r[0].offsetLeft : r[0].offsetTop, p = "x" === i ? "left" : "top";
                    switch (d) {
                        case"function":
                            return t();
                        case"object":
                ...
                function r() {
                    var e = [p[0].offsetTop, p[0].offsetLeft], i = [v[0].offsetTop, v[0].offsetLeft],
                ...
                var l = t.data(n), d = l.opt, c = {
                        ...
                        onUpdate: !0,
                        onComplete: !0
                    }, o = e.extend(c, o), u = [o.dur, o.drag ? 0 : o.dur], h = e("#mCSB_" + l.idx),
                    p = e("#mCSB_" + l.idx + "_container"), m = p.parent(),
                ...
                if (l.trigger = o.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + l.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== i || l.contentReset.y || (s("onOverflowYNone") && d.callbacks.onOverflowYNone.call(t[0]), l.contentReset.y = 1), "_resetX" !== i || l.contentReset.x || (s("onOverflowXNone") && d.callbacks.onOverflowXNone.call(t[0]), l.contentReset.x = 1), "_resetY" !== i && "_resetX" !== i) {
                    switch (!l.contentReset.y && t[0].mcs || !l.overflowed[0] || (s("onOverflowY") && d.callbacks.onOverflowY.call(t[0]), l.contentReset.x = null), !l.contentReset.x && t[0].mcs || !l.overflowed[1] || (s("onOverflowX") && d.callbacks.onOverflowX.call(t[0]), l.contentReset.x = null), d.snapAmount && (i = U(i, d.snapAmount, d.snapOffset)), o.dir) {
                        case"x":
                            var v = e("#mCSB_" + l.idx + "_dragger_horizontal"), y = "left", b = p[0].offsetLeft,
                                w = [h.width() - p.outerWidth(!1), v.parent().width() - v.width()],
                                x = [i, 0 === i ? 0 : i / l.scrollRatio.x], S = f[1], T = g[1],
                                k = S > 0 ? S / l.scrollRatio.x : 0, j = T > 0 ? T / l.scrollRatio.x : 0;
                            break;
                        case"y":
                            var v = e("#mCSB_" + l.idx + "_dragger_vertical"), y = "top", b = p[0].offsetTop,
                                w = [h.height() - p.outerHeight(!1), v.parent().height() - v.height()],
                                x = [i, 0 === i ? 0 : i / l.scrollRatio.y], S = f[0], T = g[0],
                                k = S > 0 ? S / l.scrollRatio.y : 0, j = T > 0 ? T / l.scrollRatio.y : 0
                    }
...
mejs.version = "2.18.2", mejs.meIndex = 0, mejs.plugins = {
    ...
    encodeUrl: function (e) {
        ...
        var n = t.timeFormat, o = n[0], s = n[1] == n[0], a = s ? 2 : 1, r = ":", l = Math.floor(e / 3600) % 24,
            d = Math.floor(e / 60) % 60, c = Math.floor(e % 60), u = Math.floor((e % 1 * i).toFixed(3)),
            h = [[u, "f"], [c, "s"], [d, "m"], [l, "h"]];
        n.length < a && (r = n[a]);
        ...
        var n = t.currentTimeFormat, s = Math.floor(e / 3600) % 24, a = Math.floor(e / 60) % 60, r = Math.floor(e % 60),
    ...
    init: function () {
        var e, t, i = this, n = document, o = mejs.PluginDetector.nav, s = mejs.PluginDetector.ua.toLowerCase(),
            a = ["source", "track", "audio", "video"];
        i.isiPad = null !== s.match(/ipad/i), i.isiPhone = null !== s.match(/iphone/i), i.isiOS = i.isiPhone || i.isiPad, i.isAndroid = null !== s.match(/android/i), i.isBustedAndroid = null !== s.match(/android 2\.[12]/), i.isBustedNativeHTTPS = "https:" === location.protocol && (null !== s.match(/android [12]\./) || null !== s.match(/macintosh.* version.* safari/)), i.isIE = -1 != o.appName.toLowerCase().indexOf("microsoft") || null !== o.appName.toLowerCase().match(/trident/gi), i.isChrome = null !== s.match(/chrome/gi), i.isChromium = null !== s.match(/chromium/gi), i.isFirefox = null !== s.match(/firefox/gi), i.isWebkit = null !== s.match(/webkit/gi), i.isGecko = null !== s.match(/gecko/gi) && !i.isWebkit && !i.isIE, i.isOpera = null !== s.match(/opera/gi), i.hasTouch = "ontouchstart" in window, i.svg = !!document.createElementNS && !!document.createElementNS("https://www.w3.org/2000/svg", "svg").createSVGRect;
    ...
    create: function (e, t) {
        var i, n, o = {}, s = "string" == typeof e ? document.getElementById(e) : e, a = s.tagName.toLowerCase(),
            r = "audio" === a || "video" === a, l = r ? s.getAttribute("src") : s.getAttribute("href"),
            d = s.getAttribute("poster"), c = s.getAttribute("autoplay"), u = s.getAttribute("preload"),
        ...
        var s, a, r, l, d, c, u, h, p, m, f, g = [],
            v = {method: "", url: "", htmlMediaElement: e, isVideo: "audio" != e.tagName.toLowerCase()};
        ...
        var a, r, l, d = e.htmlMediaElement, c = 1, u = 1, h = "me_" + e.method + "_" + mejs.meIndex++,
            p = new mejs.PluginMediaElement(h, e.method, e.url), m = document.createElement("div");
        p.tagName = d.tagName;
    ...
    mejs.MepDefaults = {
        ...
        hasFocus: !1, controlsAreVisible: !0, init: function () {
            ...
            var n, o, s = this, a = mejs.MediaFeatures, r = i.getAttribute("autoplay"),
            ...
            var t = this, i = 0, n = 0, o = t.controls.find(".mejs-time-rail"), s = t.controls.find(".mejs-time-total"),
                a = o.siblings(), r = a.last(), l = null;
    ...
    e.extend(mejs.MepDefaults, {progessHelpText: mejs.i18n.t("Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.")}), e.extend(MediaElementPlayer.prototype, {
        buildprogress: function (t, i, n, o) {
            ...
            var s = this, a = i.find(".mejs-time-total"), r = i.find(".mejs-time-loaded"),
                l = i.find(".mejs-time-current"), d = i.find(".mejs-time-handle"), c = i.find(".mejs-time-float"),
                u = i.find(".mejs-time-float-current"), h = i.find(".mejs-time-slider"), p = function (e) {
                    ...
                    var i = o.currentTime, n = mejs.i18n.t("Time Slider"), s = mejs.Utility.secondsToTimeCode(i, t.options),
                        a = o.duration;
                    h.attr({
                        "aria-label": n,
                        "aria-valuemin": 0,
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildvolume: function (t, i, n, o) {
            if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                var s = this, a = s.isVideo ? s.options.videoVolume : s.options.audioVolume,
                    ...
                    u = s.container.find(".mejs-volume-handle, .mejs-horizontal-volume-handle"), h = function (e, t) {
            ...
            if (t.isVideo) {
                ...
                if ("native" === a.media.pluginType || !a.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox) r.click(function () {
                    ...
                    var l = null, d = function () {
                        var e, t = document.createElement("x"), i = document.documentElement,
                    ...
                    if (d && !mejs.MediaFeatures.isOpera) {
                        var c, u, h = !1, p = function () {
                            ...
                            var e = r.offset().left - a.container.offset().left,
                                t = r.offset().top - a.container.offset().top, i = r.outerWidth(!0),
                                n = r.outerHeight(!0), o = a.container.width(), s = a.container.height();
            ...
            if ("native" === t.media.pluginType || !mejs.MediaFeatures.isFirefox && !t.options.usePluginFullScreen) {
                if (e(document.documentElement).addClass("mejs-fullscreen"), t.normalHeight = t.container.height(), t.normalWidth = t.container.width(), "native" === t.media.pluginType) if (mejs.MediaFeatures.hasTrueNativeFullScreen) mejs.MediaFeatures.requestFullScreen(t.container[0]), t.isInIframe && setTimeout(function n() {
                    if (t.isNativeFullScreen) {
                        var i = window.devicePixelRatio || 1, o = .002, s = i * e(window).width(), a = screen.width,
                            r = i * s;
    ...
    e.extend(mejs.MepDefaults, {
        ...
        webvtt: {
            ...
            parse: function (t) {
                t = e(t).filter("tt");
                var i, n, o = 0, s = t.children("div").eq(0), a = s.find("p"), r = t.find("#" + s.attr("style")),
                    l = {text: [], times: []};
                if (r.length) {
    ...
    i.extend(r, {
        ...
        _setDimension: function () {
            var e, t, n, o, s, a, l, d, c, u = r.getViewport(), h = 0, g = !1, v = !1, g = r.wrap, y = r.skin,
                b = r.inner, w = r.current, v = w.width, x = w.height, S = w.minWidth, C = w.minHeight, T = w.maxWidth,
                k = w.maxHeight, j = w.scrolling, _ = w.scrollOutside ? w.scrollbarWidth : 0, E = w.margin,
                I = m(E[1] + E[3]), M = m(E[0] + E[2]);
        ...
        _getPosition: function (e) {
            var t = r.current, i = r.getViewport(), n = t.margin, o = r.wrap.width() + n[1] + n[3],
                s = r.wrap.height() + n[0] + n[2], n = {position: "absolute", top: n[0], left: n[3]};
    ...
    var n = {
        init: function (t, i) {
            ...
            var t = this, i = !0 === t.options.scrollPerPage ? t.pagesInArray : t.positionsInArray, n = t.newPosX,
                o = null;
    ...
    function l() {
        e(window).width() > 600 ? e(".timeline").each(function () {
            ...
            i > n ? (a = i - t, r = a - o) : (a = n - t, r = a - s), d.height(a), l.css({top: "80px", height: r + "px"})
    ...
    function c() {
        var t = e(".calendar-busy"), i = t.find(".calendar-thead"), n = t.find(".calendar-tbody"),
            o = t.find(".calendar-today .day"), s = t.find(".calendar-today .month"),
            a = t.find(".calendar-today .week-day"), r = t.find(".active-month"), l = t.find(".active-year"),
            d = r.add(l);
        t.length > 0 && (z = {
    ...
    function h(e, t) {
        var i = t.attr("data-filter"), n = t.position().left, o = t.outerWidth(),
    ...
    function w() {
        var t = e("html"), i = e("body"), n = i.outerWidth(), o = i.outerHeight(),
    ...
    function I(t, i, n) {
        var o = e('<span class="ripple-effect" />'), s = parseInt(i, 10) - parseInt(t.offset().left, 10),
            a = parseInt(n, 10) - parseInt(t.offset().top, 10), r = Math.floor(.5 * Math.min(t.height(), t.width())),
    ...
    var P, F, L, A = null !== document.ontouchstart ? "click" : "touchstart", D = 0, z = new Object,
        ...
        W = "LWSKYJMPHDNGFXAZBRCQEOUTVI", O = "", R = 0, H = 0;
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (L = !0, e("html").addClass("mobile")) : (L = !1, e("html").addClass("desktop")), F = setInterval(function () {
        ...
        D.on("blur", function () {
            ...
            var t = e('<span class="ripple-effect" />'), i = e(this), n = i.width() / 2, o = i.height() / 2,
        ...
        e(window).scroll(function () {
            ...
            var i, n = e(this).closest(".contactForm"), o = n.find(".input-field"), s = n.find(".contact-name"),
                a = n.find(".contact-email"), r = n.find(".contact-message"), l = n.find(".contact-response");
