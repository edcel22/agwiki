...
<div class="page-content">
            ...
            <article>
                ...
                <p>
                    ...
                    @endguest
                      ...
                      @if($post->type=='feed' && Auth::user() && !strstr($post->content,'Read More') && !strstr($post->scrabingcontent,'Read More'))
 ...
 {{ $post->link }}
                    ...
                    <div class="post-addons likes"  @if(!Auth::user()) style="border-top: 0px" @endif>
                       ...
                       <div class="row nonLoggedInCallOutRow">
                        ...
                        <div class="col-md-8 " style="text-align:center">
                        	...
                        	<span class="nonLoggedInCallOut" >
								...
								<h3 style="color:#2980B9; font-weight:bold;">Sign up to Read the Full Article, and Join our Farm and Food Community. </h3>
...
…agricultural conversation, news, and information. </h2>
						...
						<div class="col-md-12 mb-4">
							  ...
							  <div class="card card-image" style="position: relative;background-image: url(/assets/front/img/mc_background_image.jpg);">
								  ...
								  <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4" style="padding:20px;background-color: rgba(0,0,0,0.5);z-index: 10; top: 0; left: 0; width: 100%; height: 100%;">
									  ...
									  <div>
										  ...
										  <div class="row nonLoggedInCallOutRow" style="color:white">
                                                ...
                                                <form action="https://agwiki.us4.list-manage.com/subscribe/post?u=6d6ca2b5ec8131b6fc6d33d7d&amp;id=4ab86be1a6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                                    <div id="mc_embed_signup_scroll">
                                                <div class="mc-field-group">
                                                   <!-- <label for="mce-EMAIL">Email Address </label>-->
                                                    <input style="padding:8px; margin: 0px -30px; color: #6c6c6c;" class="post-input-field form-control input-style-1" type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Your email address" required>
                                                </div>
                                                    <div id="mce-responses" class="clear">
                                                        <div class="response" id="mce-error-response" style="display:none"></div>
                                                        <div class="response" id="mce-success-response" style="display:none"></div>
                                                    </div>    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                                                    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_6d6ca2b5ec8131b6fc6d33d7d_4ab86be1a6" tabindex="-1" value=""></div>
                                                    <div class="clear"><input type="submit" value="Sign Up" name="subscribe" id="mc-embedded-subscribe" class="button button-s shadow-large button-round-small bg-green1-dark top-10"></div>
                                                    </div>
                                                </form>
                                                </div>
                                                <!--End mc_embed_signup-->	
 ...
 {{--
                                                ...
                                                <div class="mc-field-group">
                                                   <!-- <label for="mce-EMAIL">Email Address </label>-->
                                                    <input style="padding:8px; margin: 0px -17px;" class="post-input-field form-control input-style-1" type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Your email address" required>
                                                </div>
                                                    <div id="mce-responses" class="clear">
                                                        <div class="response" id="mce-error-response" style="display:none"></div>
                                                        <div class="response" id="mce-success-response" style="display:none"></div>
