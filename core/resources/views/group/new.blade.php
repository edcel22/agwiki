...
@section('content')
    ...
    <div class="single page-content">
        ...
        <form method="post" action="{{ route('user.group.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
					...
					<div class="form-group crossposting-input input-style-1">
                        ...
                        <textarea type="text" id="description" name="description" class="form-control input-style-1" style="min-height: 200px;" required ></textarea>
                    </div>
                ...
                <div class="col-md-6">
					...
					<div class="form-group crossposting-input input-style-1">
                        ...
                        <select name="acceptance" id="acceptance" class="form-control input-style-1">
                            <option value="0" selected>Approval Not Required</option>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button class="btn btn-lg btn-success btn-block button button-full button-s shadow-large button-round-small bg-green1-dark top-10" type="submit">Save Group</button>
                </div>
            </div>
            <br><br>
