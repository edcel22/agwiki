...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Login | {{$data['sitename']}}</title>
...
<div class="logo">
    <a href="#">
        <img src="{{asset('assets/front/img/logo.png')}}" alt="X" style="width:20%; -webkit-filter: brightness(0) invert(1); filter: brightness(0) invert(1);" />
    </a>
</div>
...
<div class="copyright"> {{ date('Y') }}  ©  {{ $data['sitename']}} </div>
