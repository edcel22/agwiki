...
<script src="//cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <h3 class="page-title uppercase bold"> RSS</h3>
            <a href='{{route('admin.rss.add')}}'>+ Add</a>
            <hr>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    @foreach($feeds as $post)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn edit" onClick="window.location='rss/{{ $post->id }}'" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"></i> <strong>Delete Feed</strong> </h4>
                </div>
                <form method="POST" action="{{ route('admin.rss.delete') }}" accept-charset="UTF-8">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" id="delete-id">
                    <div class="modal-body">
                        <h3 class="text-center text-danger">Are You Sure To Delete This Feed?</h3>
                    </div>
