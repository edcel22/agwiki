...
@section('body') 
    ...
    <div class="page-content">
        <h4 class="text-center">Edit Rss</h4>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group crossposting-input input-style-1">
                        ...
                        <input type="text" value="{{$rss->title}}" id="title" name="title" class="form-control input-style-1" required>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group crossposting-input input-style-1">
                        ...
                        <input type="text" value="{{$rss->url}}" id="url" name="url" class="form-control input-style-1" required>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group crossposting-input input-style-1">
                        ...
                        <input type="text" value="{{$rss->description}}" id="description" name="description" class="form-control input-style-1" required>
                    </div>
